<template>
    <div class="font-color-main md" ref="md" v-html="markdownContent">
    </div>
</template>
...
let path: null | any = null, shell: null | any = null;
    ...
    methods: {
        handleLinkClick(e: MouseEvent) {
            if (e.target instanceof HTMLAnchorElement) {
                e.preventDefault();
                if (shell && e.target.href && e.target.href.startsWith('http') && !e.target.href.startsWith('http://localhost')) {
