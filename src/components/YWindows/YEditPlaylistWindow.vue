            ...
            <div class="main">
                <div class="item">
                    ...
                    <textarea class="input font-size-large" v-model="name" :maxlength="40"
                        :placeholder="$t('edit_playlist.input_name')" rows="2"></textarea>
                </div>
                <div class="item">
                    <div class="item-title">
                        {{ $t('edit_playlist.name') }}
                    </div>
                    <textarea class="input font-size-large" v-model="desc" :maxlength="1000"
                        :placeholder="$t('edit_playlist.input_desc')" rows="3"></textarea>
                </div>
                <div class="buttons">
