    ...
    methods: {
        setupCanvas() {
            ...
            const draw = () => {
                ...
                // 绘制条形图
                const barWidth = (canvas.clientWidth / (maxIndex - minIndex)) * 2.5 - spacing; // 根据选定频率范围调整宽度
                let barHeight, x = 0;
                ...
                for (let i = minIndex; i < maxIndex; i++) {
                    ...
                    canvasCtx.quadraticCurveTo(barX + barWidth, barY, barX + barWidth, barY + radius); // 右上角圆角
